...
public class NewsDataKatalog {

    private String id, judul, datetime, gambar, like ,namaDpn,namaBlkg;

    public NewsDataKatalog(String id,String judul, String gambar, String tgl, String like, String namaDpn, String namaBlkg) {
        this.id = id;
        this.judul = judul;
        this.gambar = gambar;
        this.datetime = tgl;
