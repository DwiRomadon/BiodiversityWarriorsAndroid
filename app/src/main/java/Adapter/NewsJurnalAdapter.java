...
public class NewsJurnalAdapter extends ArrayAdapter<NewsDataJurnal> {

    private Context context;

    public NewsJurnalAdapter(Context context, ArrayList<NewsDataJurnal> a) {
        super(context,0,a);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.view_list_jurnal, parent, false);

        NewsDataJurnal news = getItem(position);
