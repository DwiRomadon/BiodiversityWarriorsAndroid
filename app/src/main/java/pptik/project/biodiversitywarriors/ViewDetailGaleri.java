...
public class ViewDetailGaleri extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_detail_galeri);

        overridePendingTransition(R.anim.slidein, R.anim.slideout);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("Detail Galeri");
    ...
    private void callDetailNews(final String id){
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Config_URL.DETAIL_POSTING, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ViewDetailGaleri.this, "Please Check Your Network Connection Or Refresh This Activity", Toast.LENGTH_LONG).show();
                Log.e(TAG, "Detail News Error: " + error.getMessage());
                /*Toast.makeText(ViewDetailGaleri.this,
    ...
    public void onBackPressed() {
        Intent a = new Intent(ViewDetailGaleri.this, GaleriActivity.class);
        startActivity(a);
        finish();
