...
public class ViewPostActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Config_URL.DETAIL_POSTING, new Response.Listener<String>() {
           ...
           // NewsData news = getItem(position);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ViewPostActivity.this, "Please Check Your Network Connection Or Refresh This Activity", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        Intent a = new Intent(ViewPostActivity.this, MainActivity.class);
        startActivity(a);
        finish();
