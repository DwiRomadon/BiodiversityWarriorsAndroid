...
public class ViewDetaiKatalog extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_detai_katalog);
    ...
    private void callDetailNews(final String id){
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Config_URL.DETAIL_POSTING, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ViewDetaiKatalog.this, "Please Check Your Network Connection Or Refresh This Activity", Toast.LENGTH_LONG).show();
                Log.e(TAG, "Detail News Error: " + error.getMessage());
                /*Toast.makeText(ViewDetaiKatalog.this,
    ...
    public void onBackPressed() {
        Intent a = new Intent(ViewDetaiKatalog.this, KatalogActivity.class);
        startActivity(a);
        finish();
