...
public class ViewDetalJurnal extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_detal_jurnal);
        overridePendingTransition(R.anim.slidein, R.anim.slideout);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("Detail Jurnal");
    ...
    private void callDetailNews(final String id){
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Config_URL.DETAIL_POSTING,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ViewDetalJurnal.this, "Please Check Your Network Connection Or Refresh This Activity", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        Intent a = new Intent(ViewDetalJurnal.this, JurnalActivity.class);
        startActivity(a);
        finish();
